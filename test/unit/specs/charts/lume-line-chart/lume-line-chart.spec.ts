...
import LumeLineChart from '../../../../../src/charts/lume-line-chart/lume-line-chart.vue';
import { BaseTestSuite } from "../../../reusable.test";

const numberOfLines = data[0].values.length;
const lineChartTestSuiteFactory = (propsData) => new BaseTestSuite(LumeLineChart, propsData);
