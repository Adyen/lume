...
| nodeExpansionTrigger | `'node' \| 'block'`                                                       | Defines which area of an expandable node toggles its expansion on click: the whole node, including its label (`'node'`, the default), or only the node block (`'block'`). Keyboard interaction always targets the whole node. |
...
| nodeLabelMaxWidth    | `number`                                                                  | Sets a maximum width for the alluvial node label text.                                                                                                                                                                        |
...
| iterations           | `number`                                                                  | Defines the number of relaxation iterations. [Read more](https://github.com/d3/d3-sankey#sankey_iterations)                                                                                                                   |
