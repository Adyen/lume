...
const DATASETS = {
  Simple: {
    data: [
      { values: [10, 30, -20, 50, 40, 70, 60], color: '01', label: 'Hamburgers' },
      { values: [30, 10, 20, 70, 50, null, 40], color: '02', label: 'Hot dogs' },
    ],
    labels: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
  },
  'Chargebacks & Fraud overview - 28 days': {
    data: [{ "values": [0.0036, 0.004, 0.0036, 0.0036, 0.0036, 0.0036, 0.0038, 0.0036, 0.0036, 0.0037, 0.0041, 0.0041, 0.0038, 0.0041, 0.004, 0.0036, 0.0036, 0.0041, 0.0041, 0.004, 0.0038, 0.0041, 0.0037, 0.0038, 0.0037, 0.0041, 0.0038, 0.0036], "label": "Chargebacks", "color": "07", "sticky": true }, { "values": [0.0007, 0.0008, 0.0007, 0.0007, 0.0007, 0.0007, 0.0007, 0.0007, 0.0007, 0.0007, 0.0009, 0.0008, 0.0007, 0.0008, 0.0008, 0.0007, 0.0007, 0.0009, 0.0008, 0.0008, 0.0007, 0.0009, 0.0007, 0.0007, 0.0007, 0.0008, 0.0007, 0.0007], "label": "NOFs", "color": "06", "sticky": true }],
